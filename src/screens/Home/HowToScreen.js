            ...
            <View>
                ...
                <ScrollView style={{marginBottom: Dimensions.get('window').height * .1, marginTop: Dimensions.get('window').height * .05}}>
                    ...
                    <Text style={styles.p}>Once every player has received their word, the game is ready to start. For this example,
                                        let's use the topic "Cereal". The ghosts will first see a screen that shows who the other 
                    ...
                    <Text style={styles.p}>The rest of the players
                                        ...
                                        to kick someone out of the game. The ghosts win the game if they eliminate enough of the other humans
                                        to become a majority, or if they can guess the topic at the end of the game!</Text>
                    <Text style={styles.p}>The humans can win
                                        by eliminating all the ghosts and if the ghosts are not able to guess the topic! They must protect the topic at all costs! 
